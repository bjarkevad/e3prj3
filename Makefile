...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu May 17 18:10:04 2012
# Project:  e3prj3.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile e3prj3.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lboost_system -lboost_thread -lQtSql -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: e3prj3.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
...
moc_carddatabase.cpp: carddatabase.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) carddatabase.h -o moc_carddatabase.cpp

moc_rfid.cpp: QAsyncSerial.h \
		rfid.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) rfid.h -o moc_rfid.cpp

moc_QAsyncSerial.cpp: QAsyncSerial.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) QAsyncSerial.h -o moc_QAsyncSerial.cpp

moc_psoc.cpp: psoc.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) psoc.h -o moc_psoc.cpp
